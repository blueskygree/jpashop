...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Assert.assertEquals("상품 주문 시 상태는 ORDER", OrderStatus.ORDER,getOrder.getStauts());
    ...
    public void 주문취소() throws Exception {
        ...
        //then
        Order getOrder = orderRepository.findOne(orderId);
        Assert.assertEquals("주문 취소시 상태는 CANCEL이다.",OrderStatus.CANCEL,getOrder.getStauts());
